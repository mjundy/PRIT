...
from . import views
from CatatPRApp.viewset_api import *
from rest_framework import routers

router = routers.DefaultRouter()
router.register('PR', PRViewSet)
...
urlpatterns = [
    ...
    path('canceled/', views.ListCanceledPR.as_view(), name='list_canceled_pr'),
    ...
    path('list/jenispart', views.ListJenisPart.as_view(), name='list_jenis_part'),
    path('register/jenispart', views.RegisterJenisPart.as_view(), name='register_jenis_part'),
    path('<int:pk>/jenispart/update/', views.UpdateJenisPart.as_view(), name='update_jenis_part'),
    path('<int:pk>/jenispart/delete/', views.DeleteJenisPart.as_view(), name='delete_jenis_part'),
    ...
    #path('export/xls/canceled/', views.export_received_pr_xls, name="export_canceled_pr_xls"),
]
